...
const promotions = [
  {
    ...
    image: 'https://cdn.pixabay.com/photo/2016/12/28/08/15/hatsune-miku-1935674_1280.png'
  },
  {
    id: 2,
    title: 'New Releases',
    description: 'Check out the latest manga releases this week',
    image: 'https://cdn.pixabay.com/photo/2023/05/28/05/34/ai-generated-8022486_1280.jpg'
  }
];
              ...
              <Grid container spacing={2}>
                {dailyUpdates.map((manga) => (
                  <Grid item key={manga.id} xs={6} sm={3}>
                    <Paper elevation={2} sx={{ position: 'relative', overflow: 'hidden', borderRadius: 2, transition: 'transform 0.3s', bgcolor: '#1e1e1e', '&:hover': { transform: 'translateY(-5px)', '& .chapter-info': { backgroundColor: '#ff6740', } } }}>
                      <Box 
                        component="img" 
                        src={manga.cover} 
                        alt={manga.title}
            ...
            <Box sx={{ position: { lg: 'sticky' }, top: { lg: 20 } }}>
              ...
              <Paper sx={{ p: 2, borderRadius: 2 }}>
                ...
                <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
                  {['Action', 'Adventure', 'Comedy', 'Drama', 'Fantasy', 'Horror', 'Mystery', 'Romance', 'Sci-Fi', 'Slice of Life', 'Sports', 'Supernatural'].map((tag) => (
                    <Button 
                      key={tag} 
                      variant="outlined" 
                      size="small"
